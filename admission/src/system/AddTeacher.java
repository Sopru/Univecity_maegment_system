...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        ImageIcon img = new ImageIcon(("/Users/barzibahadin/IdeaProjects/admission/src/system/icons/fifth.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == submit) {
            try {
                ...
                String q = "insert into teacher values('" + fNameText + "','" + lastNameText + "','" + ageText + "','" + dateOfBerthText + "','" + phoneText + "','" + emailText + "','"  + idNumberText + "','" + courseSelectedItem + "','" + departmentSelectedItem + "')";
